...
namespace Citrix.Data.Migrations
{
    ...
    [Migration("20200102121905_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Citrix.Models.ZiekModel", b =>
                {
                    ...
                    b.Property<int?>("ManagerIdBeterGemeldID")
                        .HasColumnType("int");

                    b.Property<int?>("ManagerIdZiekGemeldID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ManagerIdBeterGemeldID");

                    b.HasIndex("ManagerIdZiekGemeldID");
            ...
            modelBuilder.Entity("Citrix.Models.ZiekModel", b =>
                {
                    b.HasOne("Citrix.Models.Manager", "ManagerIdBeterGemeld")
                        .WithMany()
                        .HasForeignKey("ManagerIdBeterGemeldID");

                    b.HasOne("Citrix.Models.Manager", "ManagerIdZiekGemeld")
                        .WithMany()
                        .HasForeignKey("ManagerIdZiekGemeldID");
                });
